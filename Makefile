...
abs_srcdir=	/scratch/acurtis/Python-2.7.12
abs_builddir=	/scratch/acurtis/Python-2.7.12
...
CONFIG_ARGS=	 '--prefix=/scratch/acurtis/python' 'PKG_CONFIG_PATH=/unsup/grpc-1.0.0/lib/pkgconfig:/unsup/protobuf-3.0.2/lib/pkgconfig:/unsup/thrift-0.9.3/lib/pkgconfig:/unsup/grpc-1.0.0/lib/pkgconfig:/unsup/protobuf-3.0.2/lib/pkgconfig:/unsup/thrift-0.9.3/lib/pkgconfig:'
...
build_all_use_profile:
	$(MAKE) all CFLAGS="$(CFLAGS) $(PGO_PROF_USE_FLAG) " LDFLAGS="$(LDFLAGS) "
